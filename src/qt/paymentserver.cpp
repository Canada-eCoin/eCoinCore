...
void PaymentServer::LoadRootCAs(X509_STORE* _store)
{
    ...
    // Empty store
    if (certFile.isEmpty()) {
        qDebug() << QString("PaymentServer::%1: Payment request authentication cdn X.509 certificates disabled.").arg(__func__);
        return;
    }

...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_witness_block_size(self):
        ...
        # limit
        # Canada eCoin: scale to blocksize proportion
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # Canada eCoin: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def run_test(self):
        ...
        # Canada eCoin: Disable test due to occasional travis issue
